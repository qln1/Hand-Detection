...
// Modifies the saturation in each pixel in the given image, using saturation value in HSV
// Preconditions: image is colored and of the correct type and correctly allocated
